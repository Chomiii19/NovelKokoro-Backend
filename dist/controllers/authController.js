        ...
        switch (_b.label) {
            case 0:
                ...
                if (!username || !password)
                    return [2 /*return*/, next(new appError_1.default("Please input your username and password", 400))];
...
var login = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                if (_b)
                    return [2 /*return*/, next(new appError_1.default("Invalid username or password", 400))];
